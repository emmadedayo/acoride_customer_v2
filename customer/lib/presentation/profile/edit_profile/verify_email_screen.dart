            ...
            child: BlocListener<VerifyEmailCubit, VerifyEmailState>(
                listener: (context, state) async {
                  ...
                  if (state.hasError == true) {
                    ...
                    context.read<VerifyEmailCubit>().state.hasError = null;
                          ...
                          Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Text(
                                  'Enter the 4-digit code sent to your email address ${widget.email}',
                                ...
                                ButtonWidget(
                                  ...
                                  onTap: (){
                                    verifyContext.read<VerifyEmailCubit>().verifyEditProfile();
                                  }, radius: 30,
