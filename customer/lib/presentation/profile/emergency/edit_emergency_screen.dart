...
class UpdateEmergencyScreen extends StatefulWidget {
  ...
  const UpdateEmergencyScreen({Key? key,required this.emergencyModel}) : super(key: key);

  @override
  UpdateEmergencyScreenState createState() => UpdateEmergencyScreenState();
}


class UpdateEmergencyScreenState extends State<UpdateEmergencyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<EmergencyCubit>(
      create: (context) => EmergencyCubit(EmergencyState(emergencyModel: widget.emergencyModel),),
                                        ...
                                        ButtonWidget(
                                          ...
                                          onTap: (){
                                            ...
                                            if (_formKey.currentState!.validate()) {
                                              contextCubit.read<EmergencyCubit>().edit();
                                            } else {
