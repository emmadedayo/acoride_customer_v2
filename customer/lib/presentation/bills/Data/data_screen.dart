...
import 'components/data_components.dart';
import 'components/data_variation_screen.dart';
...
class DataScreenIndexState extends State<DataScreenIndex> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<BillsCubit>(
      create: (context) => BillsCubit(BillState(type: 'data'),),
            ...
            return BlurryModalProgressHUD(
                ...
                child: Scaffold(
                  ...
                  appBar: AppBar(
                    ...
                    elevation: 0,
                    title: Text("Data",style: HelperStyle.textStyle(context,Colors.white,17.sp,FontWeight.w500),),
                    centerTitle: true,
                    leading: IconButton(
