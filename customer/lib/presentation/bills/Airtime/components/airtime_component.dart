                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('${airtimeState.selectedBill!.name}',
                                    style: HelperStyle.textStyle(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${HelperConfig.currencyFormat(airtimeState.amount.text.toString())}",
                                    style: HelperStyle.textStyle(
                                        context, const Color(0xff3F4B69), 12, FontWeight.w400),
                                  ),
                                ],
