...
class DeliveryMapSearchAddress extends StatefulWidget {
  ...
  const DeliveryMapSearchAddress(this.nameAddressFrom, this.addressFrom, {Key? key}) : super(key: key);

  @override
  DeliveryMapSearchAddressState createState() => DeliveryMapSearchAddressState();
}

class DeliveryMapSearchAddressState extends State<DeliveryMapSearchAddress> {
  ...
  Widget build(BuildContext context) {
    return PlatformScaffold(
      ...
      appBar: PlatformAppBar(
        title: Text("Request Rides",style: HelperStyle.textStyle(
            context,
            HelperColor.black,
            14,
            FontWeight.w400),),
