...
class DeliveryOrderTripScreenWidget extends StatelessWidget {
  ...
  const DeliveryOrderTripScreenWidget({Key? key, required this.mapState,required this.rideRequestModel, required this.scrollController, this.panelController, this.onCancel, this.onPanic})
      : super(key: key);
