...
class DeliveryOrderRateDriver extends StatefulWidget {

  final RideRequestModel rideRequestModel;
  final int amountToPay;
  const DeliveryOrderRateDriver({Key? key,required this.rideRequestModel,required this.amountToPay}) : super(key: key);

  @override
  State<DeliveryOrderRateDriver> createState() => _DeliveryOrderRateDriverState();
}

class _DeliveryOrderRateDriverState extends State<DeliveryOrderRateDriver> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ButtonWidget(
                                        ...
                                        onTap: (){
                                          rideContext.read<RateCubit>().deliveryRate();
                                        },
                                        radius: 30,
                                      ),
                                    ],
